...
class Settings(BaseSettings):
    ...
    # Concurrency
    MAX_CONCURRENT_PAGES_PER_PROJECT: int = 8
    MAX_WORKERS_PER_JOB: int = 6
    ...
    MAX_CACHE_DOCUMENT_BYTES: int = 100 * 1024 * 1024  # 100 MB
    MAX_TOTAL_CACHE_BYTES: int = 512 * 1024 * 1024  # 512 MB

    # Engine Limits & Thresholds
    MAX_PAGES_PER_DOCUMENT: int = 100
    MAX_FILE_SIZE_BYTES: int = 100 * 1024 * 1024  # 100 MB
    GLOBAL_DEADLINE_SECONDS: float = 60.0
